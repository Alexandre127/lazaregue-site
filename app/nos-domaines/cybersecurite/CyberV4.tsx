...
const FAQ = [
  ...
  { q: "Faut-il informer la CNIL, l’ANSSI ou une autre autorité ?", a: "Cela dépend de ce que l’incident a touché et de ce qu’est l’entreprise. Le cabinet établit d’abord la nature de l’incident — indisponibilité, accès non autorisé, vol de fichiers, données personnelles concernées ou service essentiel perturbé —, car c’est elle qui commande les déclarations à faire. La CNIL est concernée lorsque des données personnelles ont fait l’objet d’une violation présentant un risque pour les personnes. D’autres destinataires peuvent s’ajouter selon le secteur, la qualification de l’entité ou les engagements contractuels : régulateur sectoriel, assureur, clients, personnes concernées. Chacun a son propre régime et son propre délai. La première étape est de déterminer lesquels s’appliquent réellement." },
